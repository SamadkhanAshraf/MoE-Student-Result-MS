<header class="navbar pcoded-header navbar-expand-lg header-blue navbar-light headerpos-fixed d-print-none">
    <div class="m-header">
        <a class="mobile-menu" id="mobile-collapse" href="#"><span></span></a>
        <a href="{{ route('dashboard') }}" class="b-brand">
            <!-- ========   change your logo hear   ============ -->
            <img src="{{ $setting?asset($setting->logo):''}}" alt="Logo not loaded" style="height:48px" class="logo">
            <img src="{{ $setting?asset($setting->logo):''}}" alt="Logo not loaded" style="height:48px" class="logo-thumb">
        </a>
    ...
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav ms-auto">
            <li>
                <div class="dropdown drp-localization">
                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="feather icon-globe"></i>

                        {{ $locale==='en'?'English':($locale==='pa'?'پښتو':'دری') }}
                    </a>
                    <div class="dropdown-menu dropdown-menu-end profile-notification">
                        <ul class="pro-body">
                            <li>
                                <a href="{{url('language/pa')}}" class="dropdown-item {{ $locale==='pa'?'active text-light':'' }}">
                                    <i class="feather icon-globe ms-1"></i>
                                    پښتو
                                </a>
                            </li>
                            <li>
                                <a href="{{url('language/dr')}}"
                                    class="dropdown-item {{ $locale==='dr'?'active text-light':'' }}">
                                    <i class="feather icon-globe ms-1"></i> دری
                                </a>
                            </li>
                            <li>
                                <a href="{{url('language/en')}}"
                                    class="dropdown-item {{ $locale==='en'?'active text-light':'' }}">
                                    <i class="feather icon-globe ms-1 float-start"></i>English
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ asset('assets/admin/images/user/avatar-1.jpg') }}"
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ asset('assets/admin/images/user/avatar-2.jpg') }}"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
            ...
            <li>
                <div class="dropdown drp-user">
                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                        <img src="{{ asset(auth()->user()->profile_image??'uploads/avatars/avatar.png') }}" class="img-radius wid-40"
                            alt="avatar">
                        <i class="feather icon-chevron-down"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end profile-notification">
                        <div class="pro-head d-flex">
                            <img src="{{ asset(auth()->user()->profile_image??'uploads/avatars/avatar.png') }}" class="img-radius "
                                alt="avatar">
                            <div>
                                <span class="d-block mb-0 mt-1"> {{auth()->user()->name}}</span>
                        ...
                        <ul class="pro-body">
                            ...
                            <li>
                                <a href="#" class="dropdown-item"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#show-user-profile"><i class="feather icon-user"></i>
                                        {{ __('keyword.profile') }}
                                </a>
                            </li>
                            @endcan
                            ...
                            <li>
                                <a href="#" class="dropdown-item"
                                    ...
                                    {{ __('keyword.change-password') }}
                                </a>
                            </li>
                            @endcan

                           <li>
                                <a href="{{ route('logout.lock-screen') }}" class="dropdown-item">
                                    <i class="feather icon-lock"></i>
                                    {{__('keyword.lock-screen')}}
                                </a>
                            </li>
                ...
                <div class="main-friend-cont scroll-div">
                    <div class="main-friend-list">
                        ...
                        <div class="media userlist-box" data-id="5" data-status="offline" data-username="Suzen">
                            <a class="media-left" href="#"><img class="media-object img-radius"
                                    src="{{ asset('assets/admin/images/user/avatar-4.jpg') }}"
                                    alt="Generic placeholder image"></a>
                            <div class="media-body">
