...
<div class="pcoded-inner-content">
    <div class="main-body">
        <div class="page-wrapper">
            <form action="{{ route("students.store-student-result-sheet") }}" method="post"
                                ...
                                <div class="card">
                                    <div class="card-header pb-0">
                                        <div class="d-flex justify-content-between ">
                                            <h5 class="align-self-center">{{ __('keyword.add-student-result-sheet') }}</h5>
                                    ...
                                    <div class="card-block table-border-style pb-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="semester">
                                                        ...
                                                        <option value="1">{{ __("keyword.first semester") }}</option>
                                                        <option value="2">{{ __('keyword.second semester') }}</option>
                                                        <option value="3">{{ __('keyword.third semester') }}</option>
                                                        <option value="4">{{ __('keyword.forth semester') }}</option>
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control input-mask-year graduation-year"
                                                        ...
                                                        placeholder="{{ __('keyword.enter-graduation-date') }}" />
                                            ...
                                            <div class="col-md-10 mb-3">
                                                <x-admin.form-components.select-student />
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
...
@show
<script>
    $('#student-result-sheet').on('submit', function (e) {
