                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#!">{{ __('keyword.add-collage') }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between ">
                                        <h5 class="align-self-center">{{ __('keyword.add-new-collage') }}</h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control " name="name_pa" value="{{ old('name_pa') }}" placeholder="پښتو نوم ولیکئ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control " name="name_dr" value="{{ old('name_dr') }}" placeholder="دری نوم ولیکئ">
                                                            @if ($errors->has('name_en'))
                                                                  <small id="helpId" class="form-text text-danger">{{ $errors->first('name_en') }}</small>
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <x-admin.form-components.select-departments />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
